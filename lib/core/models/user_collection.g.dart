...
int _userCollectionEstimateSize(
  ...
  bytesCount += 3 + object.urlIds.length * 8;
  return bytesCount;
}
...
void _userCollectionSerialize(
  ...
  writer.writeLongList(offsets[4], object.urlIds);
}
...
UserCollection _userCollectionDeserialize(
  ...
  object.urlIds = reader.readLongList(offsets[4]) ?? [];
  return object;
}
...
extension UserCollectionQueryWhereSort
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQueryFilter
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      urlIdsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'urlIds',
        value: value,
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      urlIdsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQuerySortBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }

  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQuerySortThenBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }

  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.desc);
    });
  }
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByEmoji(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByUrlIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'urlIds');
    });
  }
}
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, String, QQueryOperations> emojiProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, List<int>, QQueryOperations> urlIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'urlIds');
    });
  }
}
