...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get yourSaves => 'Seus links salvos';

  @override
  String get savesLastSevenDays => 'Últimos 7 dias';

  @override
  String get savesLastThirtyDays => 'Últimos 30 dias';

  @override
  String get savesEarlier => 'Anteriores';

  @override
  String get readerAskAbout => 'Pergunte sobre este conteúdo';

  @override
  String get readerEnrichingTitle => 'Você nos pegou preparando seu Glimpse.';

  @override
  String get readerEnrichingBody =>
      'Já está salvo. Estamos reunindo os detalhes úteis.';

  @override
  String get musicDetailsUnavailable =>
      'Não foi possível carregar os detalhes de algumas músicas.';

  @override
  String get loadingMusicDetails => 'Carregando detalhes das músicas…';

  @override
  String get couldNotSaveMusicProvider =>
      'Não foi possível salvar seu app de música. Tente novamente.';
  ...
  String aiSavesLeft(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Restam $count salvamentos gratuitos com IA',
      one: 'Resta 1 salvamento gratuito com IA',
    );
    return '$_temp0';
  }
  ...
  String get aiLimitBody =>
      'Você usou os 30 salvamentos gratuitos com IA vitalícios. Toque para fazer upgrade.';

  @override
  String get proAiLimitBody =>
      'Você usou 500 salvamentos com IA neste mês. O link foi salvo sem análise de IA.';
  ...
  @override
  String get processingOpeningHeadline => 'Abrindo o conteúdo';

  @override
  String get processingOpeningDetail => 'Verificando o que foi salvo';

  @override
  String processingReadingHeadline(String content) {
    return 'Lendo $content';
  }

  @override
  String get processingExtractingDetail => 'Extraindo os detalhes úteis';

  @override
  String get processingUnderstoodHeadline => 'Conteúdo compreendido';

  @override
  String get processingUnderstoodDetail => 'Transformando em algo útil';

  @override
  String get processingFindingHeadline => 'Buscando o que importa';

  @override
  String get processingFindingDetail => 'Buscando as ideias mais importantes';

  @override
  String get processingConnectingHeadline => 'Conectando os pontos';

  @override
  String get processingConnectingDetail =>
      'Conectando com itens salvos relacionados';

  @override
  String get processingFinishingHeadline => 'Finalizando seu item salvo';

  @override
  String get processingFinishingDetail => 'Preparando a busca e a redescoberta';

  @override
  String get processingRetryHeadline => 'Tentando essa etapa novamente';

  @override
  String get processingRetryDetail =>
      'Tentando esta etapa de processamento novamente';
  ...
  String get processingDefaultDetail =>
      'Buscando ideias que vale a pena guardar';
  ...
  String get freeSavesProUnlimited =>
      'Grátis: 30 com IA vitalícios · Pro: 500/mês';
  ...
  String get freeSearchesProUnlimited =>
      'Grátis: 30 buscas/mês · Pro: acesso ampliado';
  ...
  String get freeQuestionsProUnlimited =>
      'Grátis: 30 perguntas/mês · Pro: uso justo generoso';
  ...
  String get proPlanDescription =>
      '500 salvamentos com IA por mês, além de acesso ampliado ao Ask e à busca.';

  @override
  String get proPlanDevDescription =>
      '500 salvamentos com IA por mês, além de acesso ampliado ao Ask e à busca. (substituição de desenvolvimento; loja: Grátis)';

  @override
  String get freePlanDescription =>
      'Salve links sem limite e experimente IA com 30 enriquecimentos gratuitos vitalícios.';
  ...
  String get libraryDescription =>
      'Livros, filmes, lugares e música dos seus links salvos';
  ...
  String get monthlySearchLimitDescription =>
      'Você atingiu seu limite mensal de buscas. Faça upgrade para o Glimpse Pro e amplie o acesso.';
  ...
  @override
  String get recognizedOrganizedByType => 'Organizado automaticamente por tipo';
  ...
  String get libraryEmptyDescription =>
      'Salve recomendações de livros, filmes, lugares e música. O Glimpse organizará aqui o que encontrar nelas.';
  ...
  String get readerAudioUnavailable =>
      'Seu conteúdo está salvo. O texto do áudio não estava disponível, então esta prévia pode omitir detalhes do vídeo. Abra a fonte para assistir ao conteúdo completo ou adicione uma nota sobre o que chamou sua atenção.';
  ...
  String get obSummary =>
      'Explore destinos franceses menos conhecidos para uma viagem mais autêntica, aliviando a pressão sobre os lugares mais visitados.';

  @override
  String get obPoint =>
      'Vá além dos pontos mais movimentados: a França tem muito a descobrir.';

  @override
  String get obPlaceNote =>
      'Apresentado pelo criador como um destino recomendado.';
  ...
  @override
  String get obDismiss => 'Fechar guia';

  @override
  String get obFirstSave => 'Salve sua primeira descoberta';

  @override
  String get obCopy => 'Copie um link e cole no Glimpse';

  @override
  String get obReaderGuide =>
      'Leia as ideias aqui e use o Ask para explorar seu link com as fontes.';

  @override
  String get obLibraryGuide =>
      'Estes itens vêm dos seus links. Suas coleções reúnem os links que você escolher.';

  @override
  String get obRediscoverGuide =>
      'Abra uma ideia para voltar às fontes. As intenções ajudam você a retornar quando escolher.';

  @override
  String get obNotifyTitle => 'Abra espaço para um lembrete útil';

  @override
  String get obNotifyBody =>
      'Ative alertas para intenções de retorno e ideias dos seus links. Você pode mudar isso nas configurações.';

  @override
  String get obNotifyEnable => 'Ativar notificações';

  @override
  String get obNotNow => 'Agora não';

  @override
  String get obAlertsOff =>
      'Os alertas estão desativados. Suas intenções ficam no app.';

  @override
  String get obOpenSettings => 'Abrir configurações de notificações';
